...
Πρκοκειμένου να πετύχουμε την μέγιστη απόδοση του συστήματος θα ξεκινήσουμε αλλάζοντας μία μία τις παραμέτρους και ελέγχοντας τι επιπτώσεις έχουν οι αλλαγές μας στην απόδοση του συστήματος. Ως παράδειγμα θα πάρουμε ένα από τα πρώτα τρία benchmarks (το **bzip**) και ένα από τα δύο τελευταία benchmarks (το **libm**) τα οποία by default εχουν τις εξής παραμέτρους: 

**Ο λόγος που παίρνουμε δύο από αυτά τα benchmarks είναι διότι ανήκουν στις δύο κατηγορίες που αναφέραμε παραπάνω.**   
...
Με αυτές τις παραμέτρους τα αποτελέσματα που παίρνουμε είναι τα εξής:
...
|---        |---                |---                |---            |
|**CPI** *bzip*	  |**1.706679**         	|**1.67965**         |**1.650388**         |
|**CPI** *libm*	  |**3.503827**         	|**3.493415**         |**3.493414**         |  

![Image 2: L1 cache memory size](/Lab2/Charts/cpi_l1capacity.png)  

Όπως μπορούμε να διαπιστώσουμε η αύξηση της χωρητικότητας των dcache και icache οδηγεί σε βελτίωση της απόδοσης του εκτελούμενου προγράμματος καθώς το **CPI βελτιώθηκε** όταν αυξήσαμε την χωρητικότητα της μνήμης. Ωστόσο στο spec **libm** η αύξηση της χωρητικότητας δεν επέδρασε τόσο πολύ στην βελτίωση της απόδοσης. Αυτό ωφείλεται στο γεγονός ότι τα miss rates της L2 cache του συγκεκριμένου benchmark παραμένουν **πολύ υψηλά**. Συνεπώς η αύξηση της χωρητικότητας της μνήμης cache L1 (icache + dcache) δεν παίζει τόσο σημαντικό ρόλο στην βελτίωση της απόδοσης του. 
...
|---        |---                |---                |---            |--- |
|**CPI**	*bzip* |**1.712071**         	|**1.67965**         |**1.664058**        |**1.657744** |
|**CPI**	*libm* |**3.510404**         	|**3.493415**         |**3.493293**        |**3.493293** |  

![Image 3: L1 cache memory associativity](/Lab2/Charts/cpi_l1assoc.png) 

Εδώ μπορούμε να δούμε ότι η **μείωση του associativity** των dcache και icache οδηγεί σε **σημαντική αύξηση** του CPI, ενώ με την **αύξηση του associativity** οδηγούμαστε σε **καλύτερη απόδοση** του συστήματος. Εδώ και πάλι τα αποτελέσματα δεν επιρρεάζουν τόσο πολύ την *libm* καθώς εφόσον δεν έχουμε τροποποιήσει την L2 cache, τα miss rate στην L2 παραμένουν υψηλά.
...
|---        |---        |---      |---                |---            |
|sim_seconds|0.088139	    |0.085526      |0.083982	          |0.827436         | 
|**CPI**	*bzip* |**1.76277**   |**1.71052**  	|**1.67965**       |**1.653848**     |
|**CPI**	*libm* |**3.507046**   |**3.495444**  	|**3.493415**       |**3.489639**     |

![Image 4: L2 cache memory size](/Lab2/Charts/cpi_l2capacity.png)  

Όπως μπορούμε να διαπιστώσουμε η  χωρητικότητα της μνήμης cache L2 **επιρρεάζει το σύστημα μας** αφού η αύξηση της χωρητικότητας βελτιώνει την σνολική απόδοση του συστήματος. Αυτή η βελτίωση γίνεται πιο αισθητή κατά την εκτέλεση του *bzip*. Παρ'όλα αυτά υπάρχει μία αισθητή βελτίωση και στην εκτέλεση του *libm*.
...
|---        |---                |---                |---            |--- |
|**CPI**	*bzip*  |**1.688129**         	|**1.678833**         |**1.67965**        |**1.681276** |
|**CPI**	*libm*  |**3.49341**         	|**3.489639**         |**3.493415**        |**3.493415** |  

![Image 4: L2 cache memory associativity](/Lab2/Charts/cpi_l2assoc.png)   

Εδώ μπορούμε να δούμε ότι **η αλλαγή του associativity** στην L2 cache επιφέρει μηδαμινές αλλαγές στην απόδοση του συστήματός μας. Παίρνοντας υπόψιν και τον παραπάνω πίνακα, το μεγάλο miss rate της L2 cache δεν βασίζεται στα τεχνικά χαρακτηριστικά της μνήμης (L2 cache size & associativity).

### Μέγεθος cache line  

Τέλος αλλάζουμε το cache line του συστήματος. Πρώτα θα το μειώσουμε από *64Β σε **16Β** και **32Β*** και στην συνέχεια θα το αυξήσουμε από *64Β σε **128Β** .*

**Τα αποτελέσματα φαίνονται στον παρακάτω πίνακα και διάγραμμα** 

|Μέγεθος cache line   | 16B | 32B | 64B (default) | 128B |
|---        |---       |---         |---                |---            |
|**CPI** *bzip*	  |**2.111404** |**1.852581**         	|**1.67965**         |**1.666573**         |
|**CPI** *libm*	  |**9.801234**  |**5.607827**         	|**3.493415**         |**2.58129**   |  

![Image 5: cache line size](/Lab2/Charts/cpi_line.png)   

Σε αυτή την περίπτωση βλέπουμε ότι **η τροποποίηση του μεγέθους του cache line** επιρρεάζει σημαντικά την συνολική απόδοση το συστήματος. Η βελτίωση αυτή είναι ιδιαίτερα αισθητή στο δεύτερο spec *libm*. 

# Βήμα 3ο:  
  
### Εκφράσετε με μια συνάρτηση κόστους την επίδραση των παραγόντων που «πειράξατε» στο Βήμα 2 όσον αφορά το μέγεθος του κυκλώματος και την ταχύτητα;

Αρχικά θα ψάξουμε ορισμένους επεξεργαστές στην αγορά έτσι ώστε να δούμε **πόσο οι παράγοντες που είδαμε παραπάνω επιρρεάζουν το κόστος απόκτησής τους**.

Θα ασχοληθούμε με το κόστος απόκτησης του επεξεργαστή και όχι το κόστος κατασκευής του διότι δεν μπορούμε να γνωρίζουμε τα αρχικά κόστη του κατασκευαστή (εργοστάσιο, μηχανήματα, εργάτες κλπ) ούτε το κέρδος το οποίο θέλει να έχει από την πώληση του προϊόντος. 

**Στον παρακάτω πίνακα φαίνονται τα βασικά χαρακτηριστικά ορισμένων επεξεργαστών καθώς και το κόστος αγοράς του** *{πηγή: mouser.com}*

*Σημείωση: Προσπάθησα να βρω επεξεργαστές με κοντινούς χρόνους ρολογιού και με έναν πυρήνα*

| Type         | L1 dcache size | L1 dcache assoc.  | L1 icache size  | L1 icache assoc. | L2 size | L2 assoc. | cache line | price |
|---           |---             |---                |---              |---               |---      |---        |---         |---    |
|ARM AM1707    |16KB         |2                  |16KB              |2              |128KB      |4        |32B         |9.78€    |
|ARM Cortex A5 |32KB         |2                  |32KB              |2              |128KB      |8        |32B         |15.88€    |
|ARM Cortex A9 |32KB         |4                  |32KB              |4              |256KB      |8        |32B         |26€       |
|ARM Cortex A9 |32KB         |4                  |32KB              |4              |1MB        |8        |32B         |46,85€    |
|ARM Cortex A8 |32KB         |4                  |32KB              |4              |512KB      |8        |64B         |56,04€    |  

Όπως μπορούμε να διαπιστώσουμε το κόστος επιρρεάζεται από όλες τις παραμέτρους που αναλύσαμε παραπάνω. Το κόστος επιρρεάζεται λόγω χρησιμοποίησης περισσοτέρων, ή ποιοτικότερων υλικών. 

Έτσι για παράδειγμα το κόστος **αυξάνεται** όταν θέλουμε να αυξήσουμε **το μέγεθος της μνήμης** διότι πρέπει να χρησιμοποιηθούν **περισσότερα τρανζίστορσ** και δεδομένου ότι έχουμε περιορισμένο χώρο μέσα στην επεξεργαστική μονάδα χρειαζόμαστε και **ποιοτικότερα υλικά** και **νέες τεχνολογίες** τα οποία κοστίζουν περισσότερο.  

Το κόστος επίσης **αυξάνεται** όταν χρησιμοποιούμε **μεγαλύτερο associativity** διότι χρησιμοποιούνται **περισσότεροι πολυπλέκτες και πιο σύνθετα κυκλώματα** τα οποία αυξάνουν το σνολικό κόστος.  

Ένας ακόμα παράγοντας είναι η **ταχύτητα**. Η ανάπτυξη συστημάτων που λειτουργούν σε υψηλές ταχύτητες **είναι πιο δαπανηρή** και αυτό διότι πρέπει να χρησιμοποιηθούν **ποιοτικότερα υλικά που επιτρέπουν καλύτερο και γρηγορότερο έλεγχο του ρεύματος**. 

Η **ταχύτητα** σνήθως **αντιπαραβάλλεται με το μέγεθος της μνήμης** καθώς για να κερδίσουμε σε ταχύτητα πρέπει πολύ συχνά να θυσιάσουμε σε μνήμη και το αντίθετο. Αυτό σμβαίνει διότι **τα πιο γρήγορα συστήματα μνήμης έχουν μεγαλύτερα και ακριβότερα τρανζίστορ** και έτσι για λόγους χώρου και κόστους δεν είναι αποδοτική η κατασκευή μεγάλων και γρήγορων μνημών.  

### Υπολογισμός Συνάρτησης Κόστους  

Για την δημιουργία της συνάρτησης κόστους θα κάνουμε μία βασικήη θεώρηση, **ότι το κόστος αυξάνεται εκθετικά όσο αυξάνονται τα μεγέθη που το επιρεάζουν**. Αυτό σημαίνει ότι για παράδειγμα αν έχω ένα Χ κόστος για να αυξήσω το μέγεθος της L1 dcache από τα 32ΚΒ στα 64KB, τότε αν θέλω από τα 64KB να πάω στα 128KB θα έχω ένα κόστος πολύ μεγαλύτερο κ.ο.κ. 

Αυτό σημαίνει ότι οι συναρτήσεις που θα βγάλουμε θα είναι εκθετικής μορφής. Αν πάρουμε μεμονομένα κάθε στοιχείο του επεξεργαστή (L1 dcache, L1 icache, L2 cache) θα δούμε ότι το **κόστος αυξάνεται τόσο με την αύξηση της χωρητικότητας τους όσο και με την αύξηση του associativity** τους. Συνεπώς άμα εισάγουμε αυτές τις μεταβλητές σε μία εκθετική συνάρτηση καταλήγουμε σε έναν τύπο της παρακάτω μορφής:

![Image 6: L1 equation](/Lab2/Charts/L1_equation.png)   

Αντίστοιχα μπορούμε να καταλήξουμε σε μία παρόμοια εξίσωση και για την L2 cache. 

Τέλος θα πολλαπλασιάσουμε την δημιουργηθείσα εξίσωση με μία συνάρτηση που καθορίζει το κόστος αύξησης του cache line. Η **αύξηση του cache line επιρρεάζει τόσο την L1 cache οσο και την L2 cache** και ουσιαστικά η μεγάλη αύξηση του μεγάθους του οδηγεί και σε μεγάλη αύξηση του κόστους αφού επιρρεάζει σημαντικά την αύξηση της πολυπλοκότητας του συτήματός μας. Η τελική μορφή της εξίσωσης μας είναι η παρακάτω:

![Image 7: cost](/Lab2/Charts/cost.png)   

Αυτή τη στιγμή θα πρέπει να καθορίσουμε τα βάρη που θα έχει κάθε μεταβολή στο κόστος του συστήματός μας, δηλαδή τους συντελεστές (α,b,c,d,e). Αυτό μπορεί να γίνει με βάση τον παραπάνω πίνακα με τα παραδείγματα των επεξεργαστών καθώς και εμπειρικά. Για παράδειγμα οι αυξήσεις της L1 dcache σε χωρητικότητα και associativity είναι πολύ πιο κοστοβόρες από τις αντίστοιχες αυξήσεις της L2. Επίσης η αύξηση του cache line επιρρεάζει σημαντικά και το κόστος τόσο της L1 όσο και της L2. Με βάση αυτό τον κανόνα μπορούμε να καταλήξουμε στην παρακάτω εξίσωση:

![Image 8: Final equation](/Lab2/Charts/final_equation.png)   

Τα **αποτελέσματα για διάφορες τιμές φαίνονται στον παρακάτω πίνακα** και μπορούμε να τα συγκρίνουμε με τον παραπάνω πίνακα με τα παραδείγματα των επεξεργαστών. Φαίνεται ότι η προσέγγιση που έχει γίνει είναι αρκετά ικανοποιητική.
...
### Εισαγωγή των αποτελεσμάτων του Ερωτήματος 2.1 στην συνάρτηση κόστους

Σε αυτό το σημείο θα κοστολογήσουμε τα αποτελέσματά μας από το ερώτημα 2.1 και θα προσπαθήσουμε να βρούμε την πιο "οικονομική" επιλογή η οποία ταυτόχρονα εξασφαλίζει και την μέγιστη απόδοση.

#### Benchmark: bzip  

Παρακάτω βλέπουμε ένα διάγραμμα στο οποίο αναγράφεται για κάθε συνδιασμό το τελικό CPI σε σχέση με το κόστος.

![Image 9: bzip results](/Lab2/Charts/bzip_cost.png)   

Στον παρακάτω πίνακα φαίνονται η φθηνότερη, η ακριβότερη και η  επιλεγείσα "value for money" επιλογή.

|                   | Φθηνότερη επιλογή | Value for money επιλογή | Ακριβότερη επιλογή |
|---                |---          |---           |---               |
| *L1 icache size:* | 32ΚΒ          |  **64ΚΒ**        |    32ΚΒ           |
| *L1 icache assoc:* | 2           |   **2**      |     2          |
| *L1 dcache size:*|  64ΚΒ         |  **128ΚΒ**         |     64ΚΒ          |
| *L1 dcache assoc:* |  2         |    **2**       |     2          |
| *L2 size:*        |  2048ΚΒ         |    **2048ΚΒ**       |   2048ΚΒ            |
| *L2 assoc:*       |  8         |    **8**       |      8         |
| *Cache Line:*     |  16         |   **64**        |      128         |
|                   |           |           |               |
| **CPI =**         |  **2,111404**         |  **1,650388**        |    **1,666573**           |
| **Κόστος =**      |  **15,29**        |   **95,65**        |     **441,16**          |
...
| *L2 size:*        |  2048ΚΒ         |    **2048ΚΒ**       |   2048ΚΒ            |
| *L2 assoc:*       |  8         |    **8**       |      8         |
| *Cache Line:*     |  32         |   **128**        |      128         |
|                   |           |           |               |
| **CPI =**         |  **9,801234**         |  **2,58129**        |    **1,666573**           |
| **Κόστος =**      |  **15,29**        |   **441,16**        |     **441,16**          | 

Στο συγκεκριμένο παράδειγμα η πιο value for money επιλογή είναι και η ακριβότερη. Αυτό συμβαίνει διότι όπως είπαμε και στο ερώτημα 2.1, το συγκεκριμένο benchmark εχει μεγάλο miss rate στην L2 cache πράγμα που σημαίνει ότι μία από τις προτεινόμενες λύσεις είναι η **αύξηση του cache line** η οποία είναι και πολύ κοστοβόρα. Όμως από αυτή την αύξηση έχουμε μεγάλη βελτίωση του CPI σε σχέση με την επόμενη επιλογή που έχουμε η οποία κοστίζει *155,96€* και μας δίνει *CPI=3,489639*. **Η μεγάλη μείωση που έχουμε στο CPI** η οποία αγγίζει το **26%** μας οδηγεί στο να επιλέξουμε την ακριβότερη επιλογή για την εκτέλεση αυτού του benchmark. 
