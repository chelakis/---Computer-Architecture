...
Από τα αποτελέσματα συμπεραίνουμε ότι τα miss rate παραμένουν ίδια ωστόσο θα αναλύσουμε περισσότερο τον χρόνο εκτέλεσης και τα cpi. Στον παρακάτω πίνακα αντιπαρατίθενται τα αποτελέσματα από την εκτέλεση των προγραμμάτων με cpu clock στα 2GHz (αρχική εκτέλεση) και στο 1 GHz (τελευταία εκτέλεση): 
...
Στην δεύτερη κατηγορία είναι τα υπόλοιπα 2: jeng και libm, στα οποία ο χρόνος εκτέλεσης μεγάλωσε σημαντικά όταν μειώσαμε την ταχύτητα του επεξεργαστή αλλά δεν διπλασιάστηκε και τα CPI μειώθηκαν αρκετά.  
