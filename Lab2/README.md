...
|**CPI**	*libm* |**X**   |**X**  	|**3.493415**       |**X**     |


Όπως μπορούμε να διαπιστώσουμε η  χωρητικότητα της μνήμης cache L2 **επιρρεάζει σημαντικά το σύστημα μας** αφού η αύξηση της χωρητικότητας βελτιώνει την σνολική απόδοση του συστήματος ενώ εν αντιθέσει η μείωση της χειροτερεύει την συνολική απόδοση
