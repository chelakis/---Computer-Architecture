...
![Image 1: config.ini image](/Lab2/Charts/cpi_l2capacity.png)  

Όπως μπορούμε να διαπιστώσουμε η  χωρητικότητα της μνήμης cache L2 **επιρρεάζει το σύστημα μας** αφού η αύξηση της χωρητικότητας βελτιώνει την σνολική απόδοση του συστήματος. Αυτή η βελτίωση γίνεται πιο αισθητή κατά την εκτέλεση του *bzip*. Παρ'όλα αυτά υπάρχει μία μικρή βελτίωση και στην εκτέλεση του *libm*.
